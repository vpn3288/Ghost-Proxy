...
# install_landing_v6.66.sh — 落地机安装脚本
# 版本: v6.66 (2026-05-21)
# v6.66 - Base64 导入块改为 Sub-Store 友好的逐行 Mihomo 节点 JSON。
...
show_generated_nodes() {
    ...
    echo -e "${GREEN}完整双轨 Mihomo 配置文件:${NC} ${CONFIG_DIR}/clash-meta-config.yaml"
}
...
EOF
    ...
    # 默认打印 Sub-Store 可解析的逐行节点 JSON Base64；完整 YAML 保存在文件中。
    echo ""
    echo -e "${YELLOW}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo -e "${GREEN}${BOLD}  Sub-Store / Mihomo 双轨节点导入${NC}"
    echo -e "${YELLOW}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo ""
    echo -e "${YELLOW}重要提示:${NC}"
    echo "  1. 下方 Base64 解码后是 3 行单节点 JSON，给 Sub-Store 解析用"
    echo "  2. Sub-Store 中会看到 AWG-Tunnel、主轨-UDP极速、备轨-TCP稳定"
    echo "  3. 主轨依赖 AWG-Tunnel；导出到 Mihomo 时必须保留 dialer-proxy"
    echo "  4. 完整双轨 YAML 仍保存在: ${CONFIG_DIR}/clash-meta-config.yaml"
    echo ""
    ...
    echo ""
    echo -e "${GREEN}${BOLD}完整 Mihomo YAML 从此处开始复制${NC}"
