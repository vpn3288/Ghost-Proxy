...
ensure_awg_quick() {
    ...
    warn "未找到 awg-quick，尝试安装 wireguard-tools 作为 wg-quick 基础依赖"
    apt-get install -y -qq wireguard-tools >/dev/null 2>&1 || warn "wireguard-tools 安装失败，请确认落地机脚本会安装 amneziawg-tools"
}
