...
# install_landing_v6.84.sh — 落地机安装脚本
# 版本: v6.84 (2026-05-21)
# v6.84 - 拆清 Mihomo 直导、Sub-Store Provider、ClashMeta provider 引用入口。
...
三、自洽 Provider（兼容性取决于 Sub-Store/客户端）
  cat ${CONFIG_DIR}/substore-awg-for-mihomo.yaml
  该文件包含 hidden AWG-Tunnel、主轨、备轨。若 Sub-Store 丢弃 hidden 或 dialer-proxy，主轨会断链；此时改用第二种 provider-only 分离法。
